...
struct ImplementationConstants : public TpmEnum<std::uint32_t>
{
    ...
    LABEL_MAX_BUFFER = 32,
    _TPM_CAP_SIZE = sizeof(std::uint32_t),
    MAX_CAP_DATA = (1024/*MAX_CAP_BUFFER*/-_TPM_CAP_SIZE-sizeof(std::uint32_t)),
...
class TPM_DLLEXP TPMU_CAPABILITIES: public virtual TpmStructure
{
    ...
    public: virtual TPMU_CAPABILITIES* Clone() const = 0;
};
...
class TPM_DLLEXP TPMU_ATTEST: public virtual TpmStructure
{
    ...
    public: virtual TPMU_ATTEST* Clone() const = 0;
};
...
class TPM_DLLEXP TPMU_SYM_DETAILS: public virtual TpmStructure
{
    ...
    public: virtual TPMU_SYM_DETAILS* Clone() const = 0;
};
...
{
    public: virtual TPM_ALG_ID GetUnionSelector() const = 0;
    public: virtual TPMU_SENSITIVE_CREATE* Clone() const = 0;
};
...
{
    public: virtual TPM_ALG_ID GetUnionSelector() const = 0;
    public: virtual TPMU_SCHEME_KEYEDHASH* Clone() const = 0;
};
...
{
    public: virtual TPM_ALG_ID GetUnionSelector() const = 0;
    public: virtual TPMU_SIG_SCHEME* Clone() const = 0;
};
...
{
    public: virtual TPM_ALG_ID GetUnionSelector() const = 0;
    public: virtual TPMU_KDF_SCHEME* Clone() const = 0;
};
...
{
    public: virtual TPM_ALG_ID GetUnionSelector() const = 0;
    public: virtual TPMU_ASYM_SCHEME* Clone() const = 0;
};
...
{
    public: virtual TPM_ALG_ID GetUnionSelector() const = 0;
    public: virtual TPMU_SIGNATURE* Clone() const = 0;
};
...
{
    public: virtual TPM_ALG_ID GetUnionSelector() const = 0;
    public: virtual TPMU_PUBLIC_ID* Clone() const = 0;
};
...
{
    public: virtual TPM_ALG_ID GetUnionSelector() const = 0;
    public: virtual TPMU_PUBLIC_PARMS* Clone() const = 0;
};
...
{
    public: virtual TPM_ALG_ID GetUnionSelector() const = 0;
    public: virtual TPMU_SENSITIVE_COMPOSITE* Clone() const = 0;
};
...
public:
    TPM_HANDLE() { handle = TPM_RH::TPM_NULL; }
    ...
    static TPM_HANDLE Null() { return TPM_RH::TPM_NULL; }
    ...
    static TPM_HANDLE Persistent(std::uint32_t handleOffset)
    {
        return (TPM_HT::PERSISTENT << 24) + handleOffset;
    }

    /// <summary> Create a TPM_HANDLE for a PCR with given-index. </summary>
    static TPM_HANDLE Pcr(std::uint32_t PcrIndex) { return PcrIndex; }

    /// <summary> Create a TPM_HANDLE for an NV-slot. </summary>
    static TPM_HANDLE NV(std::uint32_t NvSlot)
    {
    ...
    [[deprecated("Use ctor from std::uint32_t instead")]]
    static TPM_HANDLE FromReservedHandle(TPM_RH reservedHandle)
    {
        return TPM_HANDLE(reservedHandle);
    }

    [[deprecated("Use TPM_HANDLE::Persistent(std::uint32_t) instead")]]
    static TPM_HANDLE PersistentHandle(std::uint32_t handleOffset)
    {
        return (TPM_HT::PERSISTENT << 24) + handleOffset;
    }

    [[deprecated("Use TPM_HANDLE::Pcr(std::uint32_t) instead")]]
    static TPM_HANDLE PcrHandle(int PcrIndex) { return PcrIndex; }

    [[deprecated("Use TPM_HANDLE::NV(std::uint32_t) instead")]]
...
class TPM_DLLEXP TPMS_NULL_UNION : public TPMU_SYM_DETAILS, public TPMU_SCHEME_KEYEDHASH, public TPMU_SIG_SCHEME, public TPMU_KDF_SCHEME, public TPMU_ASYM_SCHEME, public TPMU_SIGNATURE
{
public:
public:
    TPMS_NULL_UNION() {}
    TPM_ALG_ID GetUnionSelector() const { return TPM_ALG_ID::TPM_NULL; }
...
class TPM_DLLEXP TPMS_EMPTY : public TPMU_ASYM_SCHEME
{
public:
public:
    TPMS_EMPTY() {}
...
public:
    TPMS_ALGORITHM_DESCRIPTION() { alg = TPM_ALG_ID::TPM_NULL; }
...
class TPM_DLLEXP TPMT_HA : public TPMU_SIGNATURE
{
public:
...
public:
    TPMT_HA() { hashAlg = TPM_ALG_ID::TPM_NULL; }
...
class TPM_DLLEXP TPM2B_DIGEST : public TPMU_PUBLIC_ID
{
public:
...
public:
    TPMS_PCR_SELECTION() { hash = TPM_ALG_ID::TPM_NULL; }
    ...
    TPMS_PCR_SELECTION(TPM_ALG_ID hashAlg, const vector<std::uint32_t>& pcrs);

    /// <summary> Get a PCR-selection array naming exactly one PCR in one bank. </summary>
    static vector<TPMS_PCR_SELECTION> GetSelectionArray(TPM_ALG_ID hashAlg, std::uint32_t pcr)
    {
    ...
    bool PcrIsSelected(std::uint32_t pcr)
    {
        return pcrSelect[pcr / 8] = (1 << (pcr % 8)) != 0;
    }

    /// <summary> Return the current PCR-selection as a std::uint32_t array. </summary>
    vector<std::uint32_t> ToArray();
...
public:
    TPMS_ALG_PROPERTY() { alg = TPM_ALG_ID::TPM_NULL; }
...
class TPM_DLLEXP TPML_CC : public TPMU_CAPABILITIES
{
public:
...
/// </summary>
class TPM_DLLEXP TPML_CCA : public TPMU_CAPABILITIES
{
public:
...
class TPM_DLLEXP TPML_HANDLE : public TPMU_CAPABILITIES
{
public:
...
class TPM_DLLEXP TPML_PCR_SELECTION : public TPMU_CAPABILITIES
{
public:
...
class TPM_DLLEXP TPML_ALG_PROPERTY : public TPMU_CAPABILITIES
{
public:
...
class TPM_DLLEXP TPML_TAGGED_TPM_PROPERTY : public TPMU_CAPABILITIES
{
public:
...
class TPM_DLLEXP TPML_TAGGED_PCR_PROPERTY : public TPMU_CAPABILITIES
{
public:
...
class TPM_DLLEXP TPML_ECC_CURVE : public TPMU_CAPABILITIES
{
public:
...
class TPM_DLLEXP TPML_TAGGED_POLICY : public TPMU_CAPABILITIES
{
public:
...
class TPM_DLLEXP TPML_ACT_DATA : public TPMU_CAPABILITIES
{
public:
...
class TPM_DLLEXP TPMS_TIME_ATTEST_INFO : public TPMU_ATTEST
{
public:
...
class TPM_DLLEXP TPMS_CERTIFY_INFO : public TPMU_ATTEST
{
public:
...
class TPM_DLLEXP TPMS_QUOTE_INFO : public TPMU_ATTEST
{
public:
...
class TPM_DLLEXP TPMS_COMMAND_AUDIT_INFO : public TPMU_ATTEST
{
public:
...
public:
    TPMS_COMMAND_AUDIT_INFO() { digestAlg = TPM_ALG_ID::TPM_NULL; }
...
class TPM_DLLEXP TPMS_SESSION_AUDIT_INFO : public TPMU_ATTEST
{
public:
...
class TPM_DLLEXP TPMS_CREATION_INFO : public TPMU_ATTEST
{
public:
...
class TPM_DLLEXP TPMS_NV_CERTIFY_INFO : public TPMU_ATTEST
{
public:
...
class TPM_DLLEXP TPMS_NV_DIGEST_CERTIFY_INFO : public TPMU_ATTEST
{
public:
    /// <summary> Name of the NV Index </summary>
    ByteVec indexName;
...
public:
    TPMT_SYM_DEF()
    {
        algorithm = TPM_ALG_ID::TPM_NULL;
        mode = TPM_ALG_ID::TPM_NULL;
    }
...
class TPM_DLLEXP TPM2B_SYM_KEY : public TPMU_SENSITIVE_COMPOSITE
{
public:
...
class TPM_DLLEXP TPMS_SYMCIPHER_PARMS : public TPMU_PUBLIC_PARMS
{
public:
...
class TPM_DLLEXP TPMS_DERIVE : public TPMU_SENSITIVE_CREATE, public TPMU_PUBLIC_ID
{
public:
    ByteVec label;
    ByteVec context;
...
class TPM_DLLEXP TPM2B_SENSITIVE_DATA : public TPMU_SENSITIVE_COMPOSITE
{
public:
    /// <summary> Symmetric data for a created object or the label and context for a derived
    /// object </summary>
...
class TPM_DLLEXP TPMS_SCHEME_HASH : public TPMU_SCHEME_KEYEDHASH, public TPMU_SIG_SCHEME, public TPMU_KDF_SCHEME, public TPMU_ASYM_SCHEME, public TPMU_SIGNATURE
{
public:
...
public:
    TPMS_SCHEME_HASH() { hashAlg = TPM_ALG_ID::TPM_NULL; }
...
class TPM_DLLEXP TPMS_SCHEME_ECDAA : public TPMU_SIG_SCHEME, public TPMU_ASYM_SCHEME
{
public:
    /// <summary> The hash algorithm used to digest the message </summary>
    TPM_ALG_ID hashAlg;
...
public:
    TPMS_SCHEME_ECDAA() { hashAlg = TPM_ALG_ID::TPM_NULL; }
...
class TPM_DLLEXP TPMS_SCHEME_XOR : public TPMU_SCHEME_KEYEDHASH
{
public:
    /// <summary> The hash algorithm used to digest the message </summary>
    TPM_ALG_ID hashAlg;
...
public:
    TPMS_SCHEME_XOR()
    {
        hashAlg = TPM_ALG_ID::TPM_NULL;
        kdf = TPM_ALG_ID::TPM_NULL;
    }
...
public:
    ...
    public: TPM_ALG_ID scheme() const { return details ? details->GetUnionSelector() : TPM_ALG_ID::TPM_NULL; }
...
class TPM_DLLEXP TPM2B_PUBLIC_KEY_RSA : public TPMU_PUBLIC_ID
{
public:
...
class TPM_DLLEXP TPM2B_PRIVATE_KEY_RSA : public TPMU_SENSITIVE_COMPOSITE
{
public:
    ByteVec buffer;
...
/// the TPM. </summary>
class TPM_DLLEXP TPM2B_ECC_PARAMETER : public TPMU_SENSITIVE_COMPOSITE
{
public:
...
/// point. </summary>
class TPM_DLLEXP TPMS_ECC_POINT : public TPMU_PUBLIC_ID
{
public:
...
public:
    ...
    /// <summary> Scheme selector </summary>
    public: TPM_ALG_ID kdfScheme() const { return kdf ? kdf->GetUnionSelector() : TPM_ALG_ID::TPM_NULL; }
    ...
    /// <summary> Scheme selector </summary>
    public: TPM_ALG_ID signScheme() const { return sign ? sign->GetUnionSelector() : TPM_ALG_ID::TPM_NULL; }
...
class TPM_DLLEXP TPMS_SIGNATURE_RSA : public TPMU_SIGNATURE
{
public:
...
public:
    TPMS_SIGNATURE_RSA() { hash = TPM_ALG_ID::TPM_NULL; }
...
class TPM_DLLEXP TPMS_SIGNATURE_ECC : public TPMU_SIGNATURE
{
public:
...
public:
    TPMS_SIGNATURE_ECC() { hash = TPM_ALG_ID::TPM_NULL; }
...
public:
    ...
    public: TPM_ALG_ID sigAlg() const { return signature ? signature->GetUnionSelector() : TPM_ALG_ID::TPM_NULL; }
...
class TPM_DLLEXP TPMS_KEYEDHASH_PARMS : public TPMU_PUBLIC_PARMS
{
public:
    /// <summary> Selects the scheme </summary>
    public: TPM_ALG_ID schemeScheme() const { return scheme ? scheme->GetUnionSelector() : TPM_ALG_ID::TPM_NULL; }
...
class TPM_DLLEXP TPMS_ASYM_PARMS : public TPMU_PUBLIC_PARMS
{
public:
...
class TPM_DLLEXP TPMS_RSA_PARMS : public TPMU_PUBLIC_PARMS
{
public:
...
class TPM_DLLEXP TPMS_ECC_PARMS : public TPMU_PUBLIC_PARMS
{
public:
    /// <summary> For a restricted decryption key, shall be set to a supported symmetric
    /// algorithm, key size. and mode.
...
public:
    ...
    bool ValidateCertifyNV(const ByteVec& Nonce, const ByteVec& expectedContents,
                           std::uint16_t startOffset, class NV_CertifyResponse& quote) const;
...
class TPM_DLLEXP TPM2B_PRIVATE_VENDOR_SPECIFIC : public TPMU_SENSITIVE_COMPOSITE
{
public:
    ByteVec buffer;
...
public:
    TPMS_NV_PUBLIC() { nameAlg = TPM_ALG_ID::TPM_NULL; }
...
public:
    TPMS_CREATION_DATA() { parentNameAlg = TPM_ALG_ID::TPM_NULL; }
...
public:
    TPM2_StartAuthSession_REQUEST() { authHash = TPM_ALG_ID::TPM_NULL; }
...
public:
    ...
    /// <summary> Scheme selector </summary>
    public: TPM_ALG_ID inSchemeScheme() const { return inScheme ? inScheme->GetUnionSelector() : TPM_ALG_ID::TPM_NULL; }
...
public:
    TPM2_ZGen_2Phase_REQUEST() { inScheme = TPM_ALG_ID::TPM_NULL; }
...
public:
    TPM2_EncryptDecrypt_REQUEST() { mode = TPM_ALG_ID::TPM_NULL; }
...
public:
    TPM2_EncryptDecrypt2_REQUEST() { mode = TPM_ALG_ID::TPM_NULL; }
...
public:
    TPM2_Hash_REQUEST() { hashAlg = TPM_ALG_ID::TPM_NULL; }
...
public:
    TPM2_HMAC_REQUEST() { hashAlg = TPM_ALG_ID::TPM_NULL; }
...
public:
    TPM2_MAC_REQUEST() { inScheme = TPM_ALG_ID::TPM_NULL; }
...
public:
    TPM2_HMAC_Start_REQUEST() { hashAlg = TPM_ALG_ID::TPM_NULL; }
...
public:
    TPM2_MAC_Start_REQUEST() { inScheme = TPM_ALG_ID::TPM_NULL; }
...
public:
    TPM2_HashSequenceStart_REQUEST() { hashAlg = TPM_ALG_ID::TPM_NULL; }
...
public:
    ...
    /// <summary> Selector of the algorithm used to construct the signature </summary>
    public: TPM_ALG_ID signatureSigAlg() const { return signature ? signature->GetUnionSelector() : TPM_ALG_ID::TPM_NULL; }
...
public:
    TPM2_SetCommandCodeAuditStatus_REQUEST() { auditAlg = TPM_ALG_ID::TPM_NULL; }
...
public:
    TPM2_PCR_SetAuthPolicy_REQUEST() { hashAlg = TPM_ALG_ID::TPM_NULL; }
...
public:
    ...
    /// <summary> Selector of the algorithm used to construct the signature </summary>
    public: TPM_ALG_ID authSigAlg() const { return auth ? auth->GetUnionSelector() : TPM_ALG_ID::TPM_NULL; }
...
public:
    TPM2_SetPrimaryPolicy_REQUEST() { hashAlg = TPM_ALG_ID::TPM_NULL; }
...
public:
    ...
    /// <summary> Selector of the algorithm used to construct the signature </summary>
    public: TPM_ALG_ID manifestSignatureSigAlg() const { return manifestSignature ? manifestSignature->GetUnionSelector() : TPM_ALG_ID::TPM_NULL; }
